...
# En este ejemplo, estamos visualizando los clústeres utilizando las dos primeras características (ProbabilidadGanaLocal (1) y ProbabilidadGanaVisitante (2))
plt.scatter(X['ProbabilidadGanaLocal (1)'], X['ProbabilidadGanaVisitante (2)'], c=df['Cluster'], cmap='rainbow')
