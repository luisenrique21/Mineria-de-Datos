...
# Fill entre la regresión y el intervalo de confianza
plt.fill_between(X_local['ProbabilidadGanaLocal (1)'], confianza[:, 0], confianza[:, 1], color='gray', alpha=0.2, label='Intervalo de Confianza')
